 ...
 */
public class MultipartRequest extends BaseTask<String> {
    ...
    public MultipartRequest(String url, Response.ErrorListener errorListener,
                            ...
                            MultipartProgressListener progLitener,String requestTag) {
        super(Method.POST, url, errorListener,requestTag);
    ...
    private void buildMultipartEntity() {
        entity.addPart(FILE_PART_NAME, new FileBody(mFilePart, ContentType.MULTIPART_FORM_DATA, mFilePart.getName()));
        if (mStringPart != null) {
