...
public class BookmarkedMural  extends RealmObject implements RealmModel, Parcelable{
    ...
    public BookmarkedMural(){

    }

    protected BookmarkedMural(Parcel in) {
        id = in.readInt();
    ...
    public static final Creator<BookmarkedMural> CREATOR = new Creator<BookmarkedMural>() {
        @Override
        public BookmarkedMural createFromParcel(Parcel in) {
            return new BookmarkedMural(in);
        }

        @Override
        public BookmarkedMural[] newArray(int size) {
            return new BookmarkedMural[size];
        }
    };
    ...
    public static Creator<BookmarkedMural> getCREATOR() {
        return CREATOR;
    }
