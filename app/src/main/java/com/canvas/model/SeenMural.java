...
public class SeenMural extends RealmObject implements RealmModel, Parcelable{
    ...
    public static final Creator<SeenMural> CREATOR = new Creator<SeenMural>() {
        @Override
        public SeenMural createFromParcel(Parcel in) {
            return new SeenMural(in);
        }

        @Override
        public SeenMural[] newArray(int size) {
            return new SeenMural[size];
        }
    };
