...
public class LocationHelper implements PermissionUtils.PermissionResultCallback{
    ...
    public void buildGoogleApiClient(Fragment fragment) {
        mGoogleApiClient = new GoogleApiClient.Builder(context)
                .addConnectionCallbacks((CanvsMapFragment)fragment)
                .addOnConnectionFailedListener((CanvsMapFragment)fragment)
